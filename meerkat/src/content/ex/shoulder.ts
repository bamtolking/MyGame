...
export const SHOULDER: Exercise[] = [
  ...
  },
  {
    ...
    anim: {
      ...
      focus: [
        { a: 'backMid', b: 'backTop', side: 'back', kind: 'work', r: 2.4 },
        { a: 'backMid', b: 'shR', side: 'back', kind: 'work', r: 2.4, from: 0.45, to: 0.95 },
        { a: 'backMid', b: 'shL', side: 'back', kind: 'work', r: 2.4, from: 0.45, to: 0.95 },
        { a: 'shR', b: 'shL', side: 'front', kind: 'stretch', r: 2.2, from: 0.18, to: 0.82 },
      ],
      trace: ['haR'],
      zoom: 1.1,
    },
