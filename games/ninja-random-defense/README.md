> **허브 배포판**: 이 폴더는 `bamtolking/MyGame` 게임 허브의 일부로, 플레이 주소는 **https://bamtolking.github.io/MyGame/ninja-random-defense/** 입니다(허브 첫 화면: https://bamtolking.github.io/MyGame/). 허브의 워크플로가 `npm run build` 로 빌드해 배포하므로 이 폴더에는 별도 Pages 워크플로가 없습니다. 아래 "방법 1"의 설정은 허브에서 이미 되어 있습니다.
