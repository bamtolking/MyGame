// 헤드리스 Chromium(휴대폰 뷰포트 3종)으로 빌드된 game/play/index.html 을 실제로 조작하는 e2e.
...
const out = 'game/e2e-out'; mkdirSync(out, { recursive: true });
const base = 'file://' + resolve('game/play/index.html');
