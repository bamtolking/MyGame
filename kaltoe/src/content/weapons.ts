...
export const WEAPONS: WeaponDef[] = [
  ...
  // 단일 상한 = damage / hitCooldown: 보스 상대 Lv1 ≈ 60 → Lv8 ≈ 150, 작은 적은 Lv8 ≈ 72.
  {
    ...
    targeting: 'strongest',
    base: {
      damage: 12, cooldown: 1.6, amount: 1, area: 14, range: 170, speed: 320, duration: 3,
      pierce: 999, knockback: 10, hitCooldown: 0.45, interval: 0.15,
    },
    levels: [
      ...
      { desc: '피해 +4 · 넉백 +50%', delta: { damage: 4, knockback: 5 } },
    ],
  ...
  // 서류철 + 속독 스킬 → 5개 대형 부메랑 + 감속. 단일 상한 52 / 0.12 ≈ 430(실측 ≈ 390) ≈ Lv8의 2.7배.
  {
    ...
    evolved: true,
    base: {
      damage: 30, cooldown: 1.1, amount: 5, area: 22, range: 240, speed: 420, duration: 3,
      pierce: 999, knockback: 20, hitCooldown: 0.4, interval: 0.1,
