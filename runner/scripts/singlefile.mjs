// Inline the built JS/CSS into one self-contained HTML (play/index.html) — open it on a phone, no server needed.
...
// Artifact variant: the host wraps it in a document, so drop doctype/html/head/body.
