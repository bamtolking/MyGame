...
export const CHARACTERS: CharacterDef[] = [
  ...
  },
  {
    ...
    maxHp: 100, drainMul: 0.94, maxJumps: 2, glide: 240, magnetR: 0, revive: 0,
  ...
  },
  {
    ...
    maxHp: 80, drainMul: 1.15, maxJumps: 3, glide: 0, magnetR: 0, revive: 0,
  ...
  },
  {
    ...
    skillName: '국물 방울막', skillDesc: '32초마다 방울막 1개 (장애물 피격 1회 막음, 구덩이는 제외)',
    maxHp: 85, drainMul: 1, maxJumps: 2, glide: 0, magnetR: 0, revive: 0,
    skill: { kind: 'shield', every: 32, startCharged: true }, unlock: { kind: 'rank', n: 12 },
