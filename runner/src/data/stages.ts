...
export const STAGES: StageDef[] = [
  ...
  { id: '1-2', world: 1, index: 2, name: '찜통 탑', intro: '높은 탑 = 2단 점프', biome: 'market', seed: 1102, tiers: [0, 0], length: 350,
    course: ['spike_wide', 'fork_low_arch', 'rest_meadow', 'fork_single', 'bench_boost', 'spike_two', 'fork_bench', 'rest_float', 'high_shelf', 'fork_spike_easy', 'jelly_hops', 'spike_fork_easy', 'spike_double_arch'],
    pouches: [], stars: { jellyPct: 70 } },
  { id: '1-3', world: 1, index: 3, name: '초롱 아래로', intro: '걸림 = 슬라이드', biome: 'market', seed: 1103, tiers: [0, 1], length: 400,
    course: ['slide_blip', 'slide_short', 'spike_single', 'slide_pair', 'slide_hill', 'rest_lanterns', 'slide_long', 'lantern_taps', 'bench_to_slide', 'lantern_hop', 'slide_bench', 'ceiling_stroll', 'slide_trio', 'tunnel_gentle'],
    pouches: [], stars: { jellyPct: 70 } },
  { id: '1-4', world: 1, index: 4, name: '꼬치 골목', intro: '점프와 슬라이드 섞기', biome: 'market', seed: 1104, tiers: [0, 1], length: 450,
    course: ['lantern_hop', 'spike_cluster', 'slide_fork_easy', 'bench_to_slide', 'fork_spike_easy', 'rest_bench', 'set_market_roofs', 'slide_jump', 'shelf_spike', 'jump_slide', 'bench_pyramid', 'spike_fork_easy', 'slide_blip', 'stairs_gentle', 'spike_single'],
    pouches: [], stars: { jellyPct: 70 } },
  { id: '1-5', world: 1, index: 5, name: '하수구 틈', intro: '구덩이는 점프로', biome: 'market', seed: 1105, tiers: [1, 1], length: 500,
    course: ['pit_small', 'spike_single', 'pit_wide', 'pit_pair', 'rest_wave', 'double_pit', 'pit_stone', 'pit_plat', 'slide_pit_easy', 'pit_spike_easy', 'set_market_roofs', 'pit_bridge', 'pit_hop_row', 'pit_bench', 'pit_tower', 'spike_pit_rhythm', 'stairs_pit'],
    pouches: [], stars: { jellyPct: 70 } },
  { id: '1-6', world: 1, index: 6, name: '야시장 한 바퀴', intro: '야시장 총정리', biome: 'market', seed: 1106, tiers: [1, 1], length: 550,
    course: ['spike_wide', 'tut_6_recap', 'fork_single', 'slide_long', 'pit_pair', 'bench_row', 'rest_coins', 'jump_slide', 'pit_long_jump', 'high_shelf', 'set_market_roofs', 'spike_rhythm', 'tunnel_short', 'pit_tower', 'slide_jump', 'fork_twice', 'bridge_spike', 'lantern_hop'],
    pouches: [], stars: { jellyPct: 70 } },
  { id: '1-R', world: 1, index: 7, name: '한밤 골목', intro: '더 빠른 한밤 야시장', biome: 'market', seed: 1107, tiers: [2, 2], length: 550, remix: true,
    course: ['spike_wide', 'tut_6_recap', 'tall_slide', 'slide_jump_slide', 'pit_to_ledge', 'breather_slide', 'set_market_roofs', 'twin_spike_beats', 'fork_then_pit', 'read_alternate', 'wide_pit_double', 'ceiling_run', 'hang_pit', 'stairs_spikes', 'fork_twice', 'bridge_hang'],
    pouches: [], stars: { jellyPct: 70 } },
