...
export const STAGES: StageDef[] = [
  ...
  { id: '1-4', world: 1, index: 4, name: '꼬치 골목', intro: '점프와 슬라이드 섞기', biome: 'market', seed: 1104, tiers: [0, 1], length: 450,
    course: ['lantern_hop', 'spike_cluster', 'slide_fork_easy', 'bench_to_slide', 'fork_spike_easy', 'rest_bench', 'set_market_roofs', 'slide_jump', 'fork_single', 'jump_slide', 'shelf_spike', 'fork_low_arch', 'spike_fork_easy', 'fork_twice'],
    pouches: [], stars: { jellyPct: 70 } },
  { id: '1-5', world: 1, index: 5, name: '하수구 틈', intro: '구덩이는 점프로', biome: 'market', seed: 1105, tiers: [1, 1], length: 500,
    course: ['pit_small', 'spike_single', 'pit_wide', 'double_pit', 'rest_wave', 'pit_pair', 'pit_stone', 'fork_single', 'pit_plat', 'slide_pit_easy', 'pit_spike_easy', 'set_market_roofs', 'pit_hop_row', 'pit_tower', 'fork_low_arch', 'fork_twice', 'spike_pit_rhythm'],
    pouches: [], stars: { jellyPct: 70 } },
  { id: '1-6', world: 1, index: 6, name: '야시장 한 바퀴', intro: '야시장 총정리', biome: 'market', seed: 1106, tiers: [1, 1], length: 550,
    course: ['spike_wide', 'tut_6_recap', 'fork_single', 'slide_fork_easy', 'pit_pair', 'bench_boost', 'rest_coins', 'jump_slide', 'pit_long_jump', 'high_shelf', 'set_market_roofs', 'spike_rhythm', 'fork_low_arch', 'pit_tower', 'slide_jump', 'fork_twice', 'bridge_spike', 'fork_spike_easy', 'fork_bench'],
    pouches: [], stars: { jellyPct: 70 } },
