...
export const NO_REPEAT = 8;             // a chunk id cannot reappear within the last N main chunks
export const COOLDOWN_CHUNKS = 24;      // …and is strongly disfavoured within ~60 s of course
export const BREATHER_AFTER = 4;        // force a breather after this many hazard chunks in a row
...
export const SCORE_VERSION = 2;       // 2: feast candies collectible, missed letters re-offered, pit-aware director
export const DYING_T = 0.8;
export const RELAY_FREEZE_STEPS = 60;   // 1 s hand-over freeze
export const RELAY_HP_FRAC = 0.5;
export const SMASH_HITSTOP = 2;
